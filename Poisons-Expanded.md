...
{{imageMaskCorner17,--offsetX:55%,--offsetY:-57%,--rotation:0
  ![](https://raw.githubusercontent.com/IP-DND-Resources/Poisons-Expanded/refs/heads/main/img/Vials.png){height:400px,right:0px,bottom:-100px}
}}
...
Alternatively, a dose of an herbal poison can be crafted without GP costs when the following conditions are met:
- The required Herbal Poison Materials are directly supplied.
- A glass container with at least 4 ounces of space available is supplied to contain the poison dose.
- Proficiency and use of an Herbalism or Poisoner's Kit. 
...
## Conditions
### Slow-Petrify
This condition can be removed by the Lesser Restoration and Greater Restoration spells, or one dose of Soft. While you have the Slow-Petrify condition, you experience the following effects:
...
This condition can be removed with *Soft* (See Items)
...
**Potent Effect.** You gain Proficiency with the Herbalism or Poisoner's kit (choose when you select this feat). Your poisons that apply a condition or non-damaging effect other than the Poisoned condition, ignore any requirement to be "Poisoned in this way" and is affected by that condition or effect for the duration unless the creature is specifically immune to it.
...
{{imageMaskCorner20,--offsetX:-44%,--offsetY:-63%,--rotation:0
  ![](https://raw.githubusercontent.com/IP-DND-Resources/Poisons-Expanded/refs/heads/main/img/Illegal%20Goods.png){opacity:85%,width:450px,left:0px,bottom:-200px}
}}
<!-- Use --offsetX to shift the mask left or right (can use cm instead of %)
     Use --offsetY to shift the mask up or down
     Use --rotation to set rotation angle in degrees. -->
...
### Soft (100 GP)
Made from Roc's feather and other softening agents. As a bonus action you can drink or administer a vial of Soft to end the Petrify or Slow-Petrify Conditions. This item can be crafted with Alchemist's Supplies.
...
{{imageMaskCorner20,--offsetX:43%,--offsetY:-62%,--rotation:0
  ![](https://raw.githubusercontent.com/IP-DND-Resources/Poisons-Expanded/refs/heads/main/img/Blowgun.png){width:450px,right:-10px,bottom:-50px,opacity:90%,transform:scaleX(-1)}
}}
<!-- Use --offsetX to shift the mask left or right (can use cm instead of %)
     Use --offsetY to shift the mask up or down
     Use --rotation to set rotation angle in degrees. -->
